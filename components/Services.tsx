          ...
          {services.map((service, index) => (
            ...
            >
              ...
              >
                {/* Icon Box */}
                <motion.div
                  className="w-12 h-12 rounded-lg bg-gray-100 text-[#636EDF] flex items-center justify-center mb-4 group-hover:bg-[#636EDF] group-hover:text-white transition-colors"
