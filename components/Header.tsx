                        ...
                        {isMenuOpen && (
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                >
                                    <Link href="/seo-analiz" className="inline-flex items-center justify-center gap-2 bg-[#00b4d8] text-white px-6 py-2 rounded-full hover:bg-[#0096c7] transition-colors">
                                        <span>Ücretsiz Seo Analiz</span>
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                        </svg>
