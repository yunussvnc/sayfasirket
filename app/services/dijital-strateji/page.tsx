...
const features = [
  {
    title: "Hedef Odaklı Stratejik Çözümler",
    description: "Dijital varlığınızı optimize etmek için iş hedeflerinize uygun stratejik çözümler üretiyoruz. Her strateji, markanızın özel ihtiyaçlarına göre şekillendirilir."
  },
  {
    title: "Kapsamlı Dijital Analiz",
    description: "Mevcut dijital varlığınızı, rakiplerinizi ve sektör trendlerini detaylı analiz ediyoruz. Bu analizler stratejik planlamanızın temelini oluşturur."
  },
  {
    title: "Çok Kanallı Entegrasyon",
    description: "Web, sosyal medya, e-posta, SEO ve dijital reklam gibi tüm kanalları uyum içinde yönetiyoruz. Platformlar arası bütünlük sağlıyoruz."
  },
  {
    title: "Sürekli Optimizasyon",
    description: "Dijital stratejinizi sürekli takip ediyor ve performans verilerine göre optimize ediyoruz. Her adımı veriye dayalı kararlarla yönetiyoruz."
  }
];
      ...
      <section className="pb-12 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl">
            Dijital varlığınızı optimize etmek için hedef odaklı stratejik çözümler üretir. Dijital dünyada başarılı olmak için sadece teknoloji değil, doğru strateji gereklidir. Dijital strateji hizmetimizle, işletmenizin dijital yol haritasını çiziyor, hedeflerinize ulaşmanızı sağlayan kapsamlı stratejiler geliştiriyoruz.
          </p>
        </div>
      </section>
