...
const features = [
  {
    ...
    description: "Logo, renk paleti, tipografi ve görsel dil oluşturarak markanızın görsel kimliğini profesyonelce tasarlıyoruz. Her element markanızın hikayesini anlatır."
  },
  {
    title: "Marka Stratejisi",
    description: "Markanızın değerlerini, misyonunu ve hedef kitlesini analiz ederek, güçlü bir marka stratejisi geliştiriyoruz. Markanızın dijital dünyadaki konumunu belirliyoruz."
  },
  {
    title: "Marka Kılavuzu",
    description: "Markanızın tüm görsel ve yazılı unsurlarının tutarlı kullanımını sağlayan marka kılavuzu hazırlıyoruz. Bu kılavuz, markanızın her platformda aynı şekilde temsil edilmesini garanti eder."
  },
  {
    title: "Marka Uygulamaları",
    description: "Geliştirdiğimiz marka kimliğini web sitesi, sosyal medya, basılı materyaller ve dijital platformlarda uyguluyoruz. Markanızın her yerde tutarlı görünmesini sağlıyoruz."
  }
];
        ...
        <div className="container mx-auto max-w-6xl">
          <nav aria-label="Breadcrumb" className="mb-8">
            <ul className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <li>
                <span className="text-gray-900" aria-current="page">Marka Kimliği</span>
              </li>
            </ul>
          </nav>
        </div>
      ...
      <section className="pb-12 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl">
            Markanızı tanımlayan görsel ve sözel unsurları profesyonelce tasarlayıp uygular. Marka kimliği, işletmenizin müşterilerinizle kurduğu duygusal bağdır. Güçlü bir marka kimliği ile müşterilerinizde güven oluşturuyor, markanızı akılda kalıcı hale getiriyoruz.
          </p>
        </div>
      </section>
